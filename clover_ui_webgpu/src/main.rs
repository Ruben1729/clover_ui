...
use clover_ui_core::paint::Primitive;
...
async fn run(event_loop: EventLoop<()>, window: Window) {
    ...
    let vertex_data = vec![
        Primitive { position: [x, y], color },
        Primitive { position: [x + width, y], color },
        Primitive { position: [x + width, y + height], color },
        Primitive { position: [x, y], color },
        Primitive { position: [x + width, y + height], color },
        Primitive { position: [x, y + height], color },
    ];
